    ...
    return (
       <div>
            ...
            <div className="grid grid-cols-4 gap-4 m-10">
                <img className="w-full h-64 hover:" src={img1} alt="" />
                <img className="w-full h-64" src={img2} alt="" />
                ...
                <img className="w-full h-64" src={img7} alt="" />
                <img className="w-full h-64" src={img8} alt="" />
            </div>
       </div>
    );
};
