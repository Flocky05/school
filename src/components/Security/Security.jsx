...
import img4 from "../../assets/images/security/cc camera.jpg"
    ...
    return (
        <div className="bg-black p-20 text-white">
            ...
            <div className="lg:flex gap-20">
                <div className="grid grid-cols-1 lg:flex justify-between items-center p-10 border-2 rounded-lg m-10">
                    <div>
                ...
                <div className="border-2 rounded-lg p-20 m-10">
                    <img className="" src={img2} alt="" />
                    <h2 className="text-xl">Learn More</h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officiis sed est deserunt cumque quas atque nihil, in laudantium. Harum, dolores.</p>
                </div>
            </div>
        </div>
    );
